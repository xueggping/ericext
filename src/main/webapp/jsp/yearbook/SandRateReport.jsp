...
　　    function hbtnExportExcel_ServerClick(){
		window.open(getRootPath() + '/yearbook/exportExcel.do?url=' + getRootPath() + '/yearbook/sandRateReport.do&yearbook=${data.yearbook}&saveFileName=逐日平均含沙量'); 
	}
	function hbtnExportWord_ServerClick(){
		window.open(getRootPath() + '/yearbook/exportWord.do?url=' + getRootPath() + '/yearbook/sandRateReport.do&yearbook=${data.yearbook}&saveFileName=逐日平均含沙量'); 
	}
                        ...
                        <thead>
                            ...
                            <tr>
                                <td align="left" valign="bottom" nowrap>
								                     年 份:<asp:Label ID="lblYEAR" runat="server">${item.YEAR}</asp:Label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;测站编码:<asp:Label ID="lblSTCD" runat="server">${item.STCD}</asp:Label>
                                </td>
                                ...
                                <td valign="top" id="printArea" runat="server" class="prt" colspan="2">
                                    <table class="alltd" cellpadding="0" cellspacing="0" width="100%" style="font-weight: bold;
                                        ...
                                        <tr class="othertd">
                                            <td colspan="2">
                                                	最大断面平均含沙量</td>
                                            <td colspan="4">${item.znsw.MXS}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${item.MXSDT}</td>
                                            <td colspan="2">
                                             	   最小断面平均含沙量</td>
                                            <td colspan="4">${item.znsw.MNS}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${item.MNSDT}</td>
                                        </tr>
                                        <tr class="othertd">
                                            <td align="center">
                                                	附 &nbsp; &nbsp; &nbsp; &nbsp; 注</td>
