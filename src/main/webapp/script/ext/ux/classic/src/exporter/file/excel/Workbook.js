 ...
 *
 */
Ext.define('Ext.ux.exporter.file.excel.Workbook', {
    extend: 'Ext.ux.exporter.file.Base',

    requires: [
        'Ext.ux.exporter.file.excel.Worksheet',
        'Ext.ux.exporter.file.excel.Table',
        'Ext.ux.exporter.file.excel.Style',
        'Ext.ux.exporter.file.excel.Row',
        'Ext.ux.exporter.file.excel.Column',
        'Ext.ux.exporter.file.excel.Cell'
    ],
    ...
    applyStyles: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'Ext.ux.exporter.file.excel.Style');
    },

    applyWorksheets: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'Ext.ux.exporter.file.excel.Worksheet');
    },
