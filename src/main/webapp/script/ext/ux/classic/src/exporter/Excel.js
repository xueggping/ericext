 ...
 */
Ext.define('Ext.ux.exporter.Excel', {
    extend: 'Ext.ux.exporter.Base',

    alias:  'exporter.excel',

    requires: [
        'Ext.ux.exporter.file.excel.Workbook'
    ],
    ...
    getContent: function(){
        ...
        me.workbook = Ext.create('Ext.ux.exporter.file.excel.Workbook',{
            title:              config.title,
